...
const Forsale = () => {
  return (
   <section className="px-6 py-12 bg-transparent max-w-6xl mx-auto">

      {/* Heading */}
      <h2 className="text-2xl font-bold text-text mb-6 text-center">Find Your Dream Home For Sale</h2>
