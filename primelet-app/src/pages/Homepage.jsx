...
/>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-6">
        ...
        <p className="mt-6 text-center text-sm md:text-xl max-w-3xl">
          Browse through the houses and find the one thet suits you and your family, turn that dream house to a reality living
        </p>
  ...
  <button className='bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-6 py-2.5 rounded-xl transition-colors shrink-0'>
    ...
    <section className="py-16 px-6 bg-white">
      ...
      <div className="flex items-center justify-center gap-2 mb-3">
        ...
        <p className="text-xs font-semibold tracking-widest text-gray-500 uppercase">Property Types</p>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-5 max-w-5xl mx-auto">
        {propertyTypes.map((type) => (
          ...
          >
            ...
            {/* Text */}
            <div>
              <h3 className="text-base font-bold text-gray-800">{type.label}</h3>
              <p className="text-sm text-orange-500">{type.count} Properties</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="flex items-center justify-center gap-2 mt-14">
        <span className="text-orange-500 text-lg"></span>
        <p className="text-xs font-semibold tracking-widest text-gray-500 uppercase">Properties</p>
      </div>
